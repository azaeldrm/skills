...
| `tasks-step` | Implement the next incomplete step from `TASKS.md`, then stop to review |
| `tasks-run` | Implement all remaining steps from `TASKS.md` sequentially without stopping |
